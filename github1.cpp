...
// #pragma HLS INTERFACE m_axi port=sc bundle=gmem0 offset=slave 
...
// #pragma HLS INTERFACE m_axi port=len bundle=gmem0 offset=slave 
// #pragma HLS INTERFACE s_axilite port=return
	size_t dptr;
    // len = 32;
	dptr = (size_t)sc->dptr;
...
{	
// #pragma HLS INTERFACE m_axi port=A bundle=gmem0 offset=slave depth=25
// #pragma HLS INTERFACE s_axilite port=return
// #pragma HLS pipeline off
	 ...
	 */
	process_block_loop: for (j = 0; j < 24; j += 2) {
